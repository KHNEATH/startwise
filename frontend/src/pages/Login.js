    ...
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="w-full max-w-5xl min-h-[500px] rounded-3xl flex flex-col md:flex-row overflow-hidden shadow-2xl">
        ...
        <div className="flex-1 flex flex-col justify-center px-8 py-12 md:py-16 md:px-16 bg-white">
          ...
          <h2 className="text-5xl font-extrabold mb-2 leading-tight text-gray-900">Log in</h2>
          <div className="mb-6 text-base text-gray-700 font-medium">Don't have an account? <a href="/signup" className="text-black hover:underline font-bold">Create an Account</a></div>
          <form className="w-full" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-5 mb-6">
              ...
              <div className="flex justify-end">
                <a href="/forgot-password" className="text-gray-500 hover:text-black text-sm font-semibold">Forgot Password?</a>
              </div>
            </div>
